...
ebsco.setAttribute('href','https://search.ebscohost.com/login.aspx?authtype=url,uid&custid=ns110797&groupid=main&profile=ehost')
...
async function onlineLibrary(){
    ...
    // Request
    try {
        response = await fetch('https://home.gruponobre.edu.br/.netlify/functions/bibli_fan', {
        method: 'post',
        body: JSON.stringify({
            firstName,
            lastName,
