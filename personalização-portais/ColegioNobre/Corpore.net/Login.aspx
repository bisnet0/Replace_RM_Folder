<%@ page language="c#" inherits="Corpore.Net.Login, App_Web_login.aspx.cdcab7d2" culture="auto" uiculture="auto"
        ...
        <%@ Register Src="~/SharedServices/Captcha/RMSCaptcha.ascx" TagPrefix="uc1" TagName="RMSCaptcha" %>
            ...
            <head id="HEAD1" runat="server">
                ...
                <meta name="description"
                    content="Bem-vindo � rede social corporativa que vai transformar a sua empresa." />
            ...
            <body>
                            ...
                            <div id="divLogin" runat="server" class="box-formulario-login">
                                ...
                                <div class="login-body-main">
                                    ...
                                    <div class="row div-item">
                                        <input id="txtUser" runat="server" maxlength="60"
                                            class="form-control login-text login-user"
                                            placeholder="Insira seu Usu&aacute;rio ou E-mail" autofocus
                                            autocomplete="off" autocapitalize="off" autocorrect="off" type="text"
                                            data-val="true" data-val-required="Usuário ou E-mail não informado." />
                                    </div>

                                    <div class="row div-item">
                                        <input id="txtPass" type="password" runat="server" maxlength="20"
                                            autocomplete="off" class="form-control login-text login-password"
                                            placeholder="Insira sua Senha" autocapitalize="off" autocorrect="off"
                                            data-val="true" data-val-required="Senha n�o informada." />
                                    </div>

                                    <div class="row div-item">

                                        <asp:DropDownList class="form-control login-text login-alias" data-val="true"
                                            data-val-required="Informe o Alias." name="Alias" ID="ddlAlias"
                                            runat="server" meta:resourcekey="ddlAliasResource1" AutoPostBack="True">
                                        </asp:DropDownList>
                                    ...
                                    <div class="row div-item">
                                        ...
                                        <asp:Button ID="btnLogin" runat="server" CssClass="btn btn-primary login-button"
                                            Text="Acessar" OnClick="btnLogin_Click"
                                            meta:resourcekey="btnLoginResource1"></asp:Button>
                                    </div>

                                    <div class="row div-item div-manage-box">
                                        <p><a href="">
                                                <RMWF:RMWRecoverPassControl runat="server" ID="lblForgotPass"
                                                    Text="Esqueceu sua senha?" NameServer="" UserNameControl="txtUser"
                                                    Alias="ddlAlias" ServerName="RMSRecoverPass"
                                                    MethodName="GetRecoverPassServer" AliasControl="ddlAlias"
                                                    InitializeMethodName="GetRecoverPassServer" UserCaption=""
                                                    ConfirmationCaption="" CssClass="esqueceu-a-senha link"
                                                    meta:resourcekey="lblForgotPassResource1">
                                                </RMWF:RMWRecoverPassControl>
                                            </a>
                                        </p>
                                    </div>
                        ...
                        <div class="main">
                            ...
                            <div class="box-left">
                                <asp:Label ID="lblMessage" runat="server" CssClass="LoginMessage" Visible="False"
                                    ...
                                    Text="Seu acesso ao RM Portal expirou. � necess�rio fazer o Login na aplica��o.">
                                </asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="footer">
                            <div class="style1">
                                <asp:Label ID="lbNewUserCaption" runat="server" CssClass="LoginAnnonServiceCaption"
                                    Text="Curr�culo" onclick="RedirectToNewUser()"
                                    meta:resourcekey="lbNewUserCaptionResource1"></asp:Label>
                                <asp:Label ID="lbCotacaoCaption" runat="server" CssClass="LoginAnnonServiceCaption"
                                    Text="Cota��o On-line" onclick="RedirectToCotacao()"
                                    meta:resourcekey="lbCotacaoCaptionResource1"></asp:Label>
                                <asp:Label ID="lblExecutorCaption" runat="server" CssClass="LoginAnnonServiceCaption"
                                    onclick="RedirectToExecutor()" Text="Executor Web"
                                    meta:resourcekey="lblExecutorCaptionResource1"></asp:Label>
                                <asp:Label ID="Label3" runat="server" CssClass="LoginAnnonServiceCaption"
                                    onclick="RedirectToPesquisaAcervoBiblios()" Text="Pesquisar acervo"
                                    meta:resourcekey="lbPesquisaAcervo"></asp:Label>
                                ...
                                <asp:Label ID="lbReportsCertificateCaption" runat="server"
                                    CssClass="LoginAnnonServiceCaption" Text="Certificador de Relat�rios"
                ...
                <script type="text/javascript"
                    src="SharedServices/ClientScripts/jquery.validate.unobtrusive.min.js"></script>
